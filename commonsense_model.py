...
class CommonsenseRNN(nn.Module):
    ...
    def forward(self, U, x1, x2, x3, o1, o2, qmask, train):
        """
        U -> seq_len, batch, D_m
...
class CommonsenseGRUModel(nn.Module):
    ...
    def CKESCL_encode(self, r1, r2, r3, r4, x1, x2, x3, o1, o2, qmask, umask, train=True, train2=True, att2=False, return_hidden=False):
    ...
    def forward(self, r1, r2, r3, r4, x1, x2, x3, o1, o2, qmask, umask, train=True, train2=True, att2=False, return_hidden=False):
        """
        U -> seq_len, batch, D_m
        qmask -> seq_len, batch, party
        """

        #print(qmask.shape, umask.shape)
        ...
        #print(r.shape, x1.shape, qmask.shape)

        emotions_f, alpha_f = self.cs_rnn_f(r, x1, x2, x3, o1, o2, qmask, train)
        ...
        #print(r.shape, rev_r.shape)

        emotions_b, alpha_b = self.cs_rnn_r(rev_r, rev_x1, rev_x2, rev_x3, rev_o1, rev_o2, rev_qmask, train)
        ...
        return log_prob, hidden, alpha, alpha_f, alpha_b, emotions
